...
// contract L1L1OpUSDCFactoryForTest is L1OpUSDCFactory {
//   constructor(address _usdc, address _createX, uint256 _salt) L1OpUSDCFactory(_usdc, _createX, _salt) {}
...
//   L1L1OpUSDCFactoryForTest public factory;
...
//   IL1OpUSDCFactory.DeployParams internal _params;

//   function setUp() public {
//     // Deploy factory
//     factory = new L1L1OpUSDCFactoryForTest(_usdc, _createX, _inputSalt);
//     // Define the params to call the `deploy()` function
//     _params = IL1OpUSDCFactory.DeployParams({
...
// contract L1OpUSDCFactory_Unit_ParseSalt is Base {
//   /**
...
// contract L1OpUSDCFactory_Unit_GetGuardedSalt is Base {
//   /**
